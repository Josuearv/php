...
<body>
    <div @click="ocultarMenusNotificacoes($event)" id="App">
        ...
        <section class="section__account-background">
            ...
            <div class="warning warning--nones">
              <div class="block__warning-text">
                  <img src="../assets/images/index2/info.png" alt="round ball of black color with an i in the middle with transparent background" width="25" height="25"/>
                   Seus recebimentos ainda não foram processados verifique o calendario de recebimentos.
              </div>
            </div>
                  ...
                  <footer class="nav-background-visibled">
                    <div class="nav-background-container">
                        ...
                        <div class="block__confirms" onclick="window.location.href='receipts.php';">
                            <input type="radio" name="sizesz" id="Receiveds" checked />
            ...
            <footer class="nav-background">
                <div class="nav-container">
                    ...
                    <div class="block__confirm" onclick="window.location.href='receipts.php';">
                        <input type="radio" name="sizes" id="Received" checked />
        ...
        <section class="no__receipts-background">
            <div class="no__receipts-container">
                <div class="warning warning--disable">
                    <span class="text__warning">avisos</span>
                    <div class="block__warning-text">
                        <img src="../assets/images/index2/info.png" alt="round ball of black color with an i in the middle with transparent background" width="25" height="25"/>
                         Seus recebimentos ainda não foram processados verifique o calendario de recebimentos.
                    </div>
                ...
                <div class="information__money-background">
                    <div class="border__background-book">
                        <img src="../assets/images/index2/livro.png" alt="green book" width="120" height="120"/>
                    </div>
                    <h2 class="text__information-receipt">Sem recebimentos nesse período</h2>
                    <span class="title__money title__money--bold">Tente usar outros períodos ou parâmetros nos filtros.</span>
                    <button class="button__receipt">calendario de recebimento</button>
